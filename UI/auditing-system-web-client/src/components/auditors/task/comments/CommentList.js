        ...
        <Container>
            <Row>
                <Col style={{ ...styles.textAlignRight, ...styles.addButtonCol }}>
                    <Button disabled={disable} type='button' onClick={() => toggleModel()}>Add Comment</Button>
                </Col>
            </Row>
            <Table>
                <thead>
                            ...
                            commentList.map(com => {
                                return <tr key={com.id}>
                                    ...
                                    <td style={{ ...styles.actionColumn, ...styles.textAlignRight }}>
                                        <Button
                                            disabled={(props.loggedInUser.id !== com.createdBy || disable)}
                                            type="button"
                                            onClick={() => {
                                                toggleModel();
                                        ...
                                        <Button
                                            disabled={(props.loggedInUser.id !== com.createdBy || disable)}
                                            style={styles.deleteButton} type='button' onClick={() => {
                                                toggleRemoveModel();

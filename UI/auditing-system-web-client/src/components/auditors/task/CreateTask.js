    ...
    const submitHandler = () => {
        ...
        if (validateForm()) {
            ...
            if (mode == operationMode.EDIT) {
                ...
                data.taskStatusId = props.task.taskStatusId === taskStatus.Completed
    ...
    return (
        <Card>
            ...
            <CardBody>
                    ...
                    <Row>
                        <Col>
                            <FormGroup>
                                ...
                                {/* {console.log('Rendred User Ids', formData.userIds)} */}
                                <Select
                                    options={props.users}
                                    isMulti
                    ...
                    <Row>
                        <Col>
                            <FormGroup>
                                ...
                                {console.log(formData.taskDescription)}
                                <Input
                                    disabled={true}
                ...
                <DocumentsAndCommentsLayout taskStatusId={props.task?.taskStatusId} taskId={taskGuid} portfolioId={portfolioId} />

                <br />

                <Button disabled={props.task?.taskStatusId === 3} type="button" color="primary" onClick={submitHandler}> {mode === operationMode.EDIT ? 'Update' : 'Create'} Task</Button>{' '}
